...
class NeXt(nn.Module):
    ...
    def __init__(self,
        ...
        self.res_cbam_3 = CBAM(channel=n_channels * 8)
        ...
        self.res_cbam_2 = CBAM(channel=n_channels * 4)
        ...
        self.res_cbam_1 = CBAM(channel=n_channels * 2)
        ...
        self.res_cbam_0 = CBAM(channel=n_channels)
